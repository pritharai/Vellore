...
const HeroCoreStory = () => {
  const storyOne = {
    ...
    description:"He trusted the hype, the followers, the flawless lives shown online. But when silence came, so did clarity. He saw how fake smiles masked broken hearts and success was often a rented set. Now, with open eyes, he walks differently—quiet, observant, awake. Because once you see the truth, the lies can never blind you again."
  }
  const storyTwo = {
    title:"Outline of a Legend",
    subtitle:"Raw Lines. Real Stories.",
    image:"/images/hero-core-2.jpg",
    description:"He wasn’t born a masterpiece — he was drawn in pieces. One line at a time. Each stroke on the back of this tee captures the chaos, the grind, the glory. This is for the ones who don’t chase the spotlight — they become it. Who let their journey speak before they do. Who wear their hustle like art — raw, rough, and real. This design isn't printed. It’s etched with experience."
  }
  return (
